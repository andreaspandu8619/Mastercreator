            ...
            <div className="fixed inset-0 z-30 bg-[hsl(var(--background))] p-3 md:p-6">
              ...
              <div className="relative h-[calc(100vh-86px)] w-full overflow-hidden rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-0">
                ...
                <div
                  ...
                  className="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-28 bg-gradient-to-t from-[hsl(var(--hover-accent))/0.35] via-[hsl(var(--hover-accent))/0.14] to-transparent"
                >
                  <div className="absolute inset-x-0 bottom-2 text-center text-xs font-medium text-[hsl(var(--foreground))/0.88]">
                    Drop here to return card to deck
                  </div>
                </div>

                <div className="absolute inset-x-6 bottom-2 z-20 overflow-visible">
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent_0%,hsl(var(--hover-accent)/0.14)_58%,hsl(var(--hover-accent)/0.8)_66%,hsl(var(--hover-accent)/0.98)_100%)]" />
                ...
                <div className="absolute inset-y-0 right-0 w-24 translate-x-full bg-white transition-transform duration-300 group-hover:translate-x-0">
                  <div className="flex h-full items-center justify-center">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[hsl(var(--border))] bg-white/90">
                      <ArrowLeft className="h-4 w-4 rotate-180 opacity-0 transition-opacity duration-200 group-hover:opacity-100 group-hover:animate-[spin_0.8s_ease-out_1] group-hover:[animation-direction:reverse]" />
                    </div>
                  </div>
                </div>
              </button>
